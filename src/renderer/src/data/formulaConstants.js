...
export const COEFFICIENT_GROUPS = [
  {
    ...
    coefficients: [
      ...
      {
        key: 'DMG_ST_DOT',
        label: 'Single Target DOT',
        description: 'Single-target damage over time'
      },
      {
        key: 'DMG_ST_HDIR',
        label: 'Single Target Hybrid Direct',
    ...
    coefficients: [
      {
        key: 'CONV_ST',
        label: 'Single Target',
        description: 'Direct single-target conversion (e.g. HP/MP to damage)'
      },
      {
        key: 'CONV_ST_DOT',
        label: 'Single Target DOT',
        description: 'Single-target conversion over time'
      },
      {
        key: 'CONV_ST_HDIR',
        label: 'Single Target Hybrid Direct',
