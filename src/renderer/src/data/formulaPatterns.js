...
const BUILTIN_PATTERNS = [
  {
    ...
    parameters: [
      ...
      },
      {
        ...
        type: 'number',
        description:
          'Optional. Multiplier applied to SOURCEWEAPONSMALLDAMAGE (or SOURCEWEAPONLARGEDAMAGE). Set to 0 or leave empty to omit weapon damage.',
        optional: true
      },
      {
        key: 'StatBlock',
    ...
    parameters: [
      {
        ...
        type: 'number',
        description:
          'Flat multiplier on the level delta (SOURCELEVEL − ACQUIREDLEVEL, floor 1) for the base damage term.'
      },
      {
        key: 'Rand',
        label: 'Random Term',
  ...
  },
  {
    ...
    structure: '{ManaCost} * {StatCalc} + {BaseDamage}',
    ncalc: '{ManaCost} * {StatCalc} + {BaseDamage}',
    parameters: [
      {
        key: 'ManaCost',
        label: 'Mana Cost',
  ...
  },
  {
    ...
    structure: '{BaseDamage} + {StatBlock} + SOURCEWEAPONSMALLDAMAGE',
    ncalc: '{BaseDamage} + {StatBlock} + SOURCEWEAPONSMALLDAMAGE',
    parameters: [
      {
        key: 'BaseDamage',
        label: 'Base Damage',
