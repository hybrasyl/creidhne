...
import {
  ...
  Button, Tooltip, IconButton, Snackbar, Alert, CircularProgress,
} from '@mui/material';
...
function StringsPage() {
  ...
  useEffect(() => {
    if (!activeLibrary) { setFiles([]); setArchivedFiles([]); setSelectedFile(null); setEditingLocalization(null); setLoading(false); return; }
    setLoading(true);
    Promise.all([
