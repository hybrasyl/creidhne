...
function CastablesPage() {
  ...
  // still somewhere you might file a castable.
  ...
  const doSelect = async (file) => {
    ...
    try {
      ...
      if (!c.meta?.isTest && !c.meta?.isGM && !c.meta?.deprecated) {
        ...
        const inferred = base.startsWith('1test')
          ? { isTest: true, isGM: false, deprecated: false }
          : base.startsWith('3gm')
            ? { isTest: false, isGM: true, deprecated: false }
            : base.startsWith('2arch')
              ? { isTest: false, isGM: false, deprecated: true }
              : null
