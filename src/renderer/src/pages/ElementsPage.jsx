...
function ElementsPage() {
  ...
  const handleArchive = async () => {
    ...
    if (result?.conflict) {
      setSnackbar({
        message: 'An archived element table with this name already exists.',
        severity: 'error'
      })
      return
    }
  ...
  const handleUnarchive = async () => {
    ...
    if (result?.conflict) {
      setSnackbar({
        message:
          'An active element table with this name already exists. Rename the archived file before unarchiving.',
        severity: 'error'
      })
      return
    }
