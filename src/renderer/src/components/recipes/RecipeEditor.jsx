...
import {
  ...
  Paper, Autocomplete, Snackbar, Alert,
} from '@mui/material';
...
function RecipeEditor({ recipe, initialFileName, isArchived, isExisting, onSave, onArchive, onUnarchive, onDirtyChange, saveRef }) {
  ...
  const [fileName, setFileName] = useState(initialFileName || computeRecipeFilename(deriveRecipePrefix(initialFileName, recipe.name), recipe.name));
