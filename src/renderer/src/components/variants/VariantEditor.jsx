...
function VariantAccordion({ variant, index, onChange, onRemove }) {
  ...
  const updateProp = (key, value) => onChange({ ...variant, properties: { ...p, [key]: value } })
            ...
            <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              <FormControl size="small" sx={{ minWidth: 160 }}>
                ...
                <Select
                  ...
                  label="Body Style"
                  onChange={setAppearanceField('bodyStyle')}
                >
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    onChange={(e) =>
                      updateProp('appearance', { ...p.appearance, hideBoots: e.target.checked })
                    }
                  />
                }
                label="Hide Boots"
...
function VariantEditor({
  ...
  const [fileName, setFileName] = useState(
    initialFileName ||
      computeVariantFilename(
        deriveVariantPrefix(initialFileName, variantGroup.name),
        variantGroup.name
      )
  )
