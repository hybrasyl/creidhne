...
const CREATURE_PROPS = new Set(['WeaponSmallDamage', 'WeaponLargeDamage'])

// Properties on MapObject — routed to map.{Prop}
const MAP_PROPS = new Set(['X', 'Y', 'Tiles', 'BaseLevel'])
